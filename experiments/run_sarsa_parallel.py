...
def _run_single_experiment(
    ...
    print(f"[SARSA] Completed Run {seed_idx + 1} (throughput: {throughput:.4f})")
    
    return successes, returns, lengths, throughput, agent, env


def run_sarsa_parallel(
    num_episodes=1000,
    num_runs=5,
    shaping_type=None,
    grid_rows=6,
    ...
    """
    Run SARSA experiments in parallel over multiple random seeds.
    ...
    print("="*60)
    print("SARSA HYPERPARAMETERS (PARALLEL)")
    print("="*60)
    print(f"Environment:")
...
if __name__ == "__main__":
    print("Testing PARALLEL SARSA on 6x6 grid with 15% holes...")
    successes, returns, lengths = run_sarsa_parallel(
        num_episodes=500,
